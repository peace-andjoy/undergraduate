...
args = parser.parse_args("--dataset acl --data_path ./data_acl_largev --emb_path ./embeddings/acl/skipgram_emb_300d.txt --min_df 10 --num_topics 40 --lr 0.0001 --epochs 1000 --mode train".split())
...
dat = pickle.load(open('../en.pkl','rb'))
dat = dat[dat['ab_words'].notnull()]
dat = dat[(dat['Publication Year'] < 2020) & (dat['Publication Year'] >= 2004)]
...
time_slice = dat['Publication Year'].value_counts().sort_index().values.tolist()
...
ckpt = os.path.join(args.save_path, 
        '/home/xueqiong/undergraduate/DETM-master/results/detm_en_Htheta_800_Optim_adam_Clip_0.0_ThetaAct_relu_Lr_0.0001_Bsz_1000_RhoSize_300_L_3_minDF_10_trainEmbeddings_1')
