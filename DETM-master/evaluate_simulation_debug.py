...
args = parser.parse_args("--dataset acl --data_path ./data_acl_largev --emb_path ./embeddings/acl/skipgram_emb_300d.txt --min_df 10 --num_topics 10 --m_set 100 --t_set 5 --len_docs 50 --lr 0.0001 --epochs 1000 --mode train --idx_sim 0".split())
...
# %%
res = {'train_ppl': train_ppl, 'val_ppl': val_ppl, 'test_ppl': test_ppl, 'td': td, 'cs': np.mean(CS)}
